...
class SceneSerializer {
    ...
    deserializeActors(actorData) {
        ...
        actorData.forEach(data => {
            ...
            if (!actor) return; // Skip if actor creation failed
...
// Physics relationships moved to PhysicsEngine module
...
// Physics properties moved to PhysicsEngine module

// Velocity tracking for momentum (now managed by StateManager)

// Texture management system is now loaded from js/core/TextureManager.js
...
// Audio system is now loaded from js/core/AudioSystem.js

// Get bounding box for an object (prop or actor)
// Physics collision detection moved to PhysicsEngine module

// Make physics functions available globally for RenderLoop using PhysicsEngine
window.updatePropRelationships = (obj) => window.stagePhysicsEngine.updateObjectRelationships(obj);
window.checkAllCollisions = (obj, x, z, vel) => window.stagePhysicsEngine.checkAllCollisions(obj, x, z, vel);
window.getObjectFriction = (obj) => window.stagePhysicsEngine.getObjectFriction(obj);
